...
const createTuyaBaseExtend = () => {
    const extension = tuya.modernExtend.tuyaBase({
        dp: true,
        queryOnConfigure: true,
        queryOnDeviceAnnounce: true,
    });
    extension.options = (extension.options || []).filter((option) => option.property !== "time_start");
    return extension;
};
